	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-well">
				<div class="media">
					<div class="media-left"><a href="#"><img src="{{ asset('flower/img/115x115.png')}}" alt="img-holiwood"></a></div>
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 img-well">
				<figure id="img-about"><a href="#"><img src="{{ asset('flower/img/660x360.png')}}" alt="img-holiwood"></a></figure>
			</div>
		</div>
	</div>
</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 team-account">
				<a href="#"><img src="{{ asset('flower/img/315x400.png')}}" class="img-responsive" alt="img-holiwood"></a>
				<div class="title-acc">
					<h2>LILA SIMPSON</h2>
					<p>Stylist</p>
  ...
  <div class="carousel-inner">
    <div class="item active">
		...
		<div class="img-customer">
			<img src="{{ asset('flower/img/115x115.png')}}" alt="img-holiwood">
		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="img-color-1">
					...
					<img src="{{ asset('flower/img/70x71.png')}}" class="img-responsive" alt="img-holiwood">
					</div>
				<h1>100%</h1>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="img-color-2">
					<div class="img-content">
					<img src="{{ asset('flower/img/82x62.png')}}" class="img-responsive" alt="img-holiwood">
				</div>
				<h1>100%</h1>
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="img-color-3">
					<div class="img-content">
					<img src="{{ asset('flower/img/62x62.png')}}" class="img-responsive" alt="img-holiwood">
				</div>
				<h1>100%</h1>
