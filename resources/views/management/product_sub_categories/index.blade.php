              ...
              <div id="panel-1" class="panel panel-default">
                <div class="panel-heading">
                  ...
                  <ul class="options pull-right list-inline">
                    ...
                    <li>
                      <a href="{{ route('product-categories.create')}}" class="btn btn-sm btn-success btn_create_new_user">
            ...
            function reloadTbl(load=false){
              if(load){
               ...
               var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('product-sub-categories.index') }}",
                columns: [
                {data: 'name', name: 'name'},
                {data: 'product_category.name', name: 'name'},
