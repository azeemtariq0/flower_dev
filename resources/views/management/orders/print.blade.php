	...
	<body>
		...
		<article>
			...
			<address contenteditable>
				<p>Resident : {{ @$data->first_name.' '.$data->last_name }}</p>
				<p>Address : {{ @$data->address}}</p>
				<p>Mobile No : {{ @$data->phone_no}}</p>
			...
			<table class="meta">
				...
				<tr>
					...
					<td><span >{{ date('d M Y',strtotime($data->date)) }}</span></td>
				</tr>
			...
			<table class="inventory">
				...
				<tbody>
					...
					<tr>
						<th colspan="5">Amount in Words : <span>{{ Number2Words($data->totalAmount)  }} Only</span> </th>
					</tr>
				</tbody>
			</table>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix>${{ $data->totalAmount }}</span><span></span></td>
				</tr>
			</table>
		</article>
		<aside style="margin-bottom: 10px;display:none;">
