...
<main>
    ...
    <div class="banner" style="margin-top: 150px;">
        <div class="container">
            <figure id="banner-about"><a href="#"><img src="{{ asset('flower/img/slide.png')}}" width="100%" class="img-responsive" alt="img-holiwood"></a></figure>
                ...
                <div class="container container-ver2">
                    ...
                    @if(session('cart'))
                        @foreach(session('cart') as $id => $details)
                                <tr class="item_cart">
                                    <td class="product-photo"><img src="{{ asset('flower/img/slider2.png')}}" width="100" alt="Futurelife"></td>
                                    <td class="produc-name"><a href="#" title="">{{ $details['name'] }}</a></td>
                                    <td class="produc-price"><input value="${{ $details['price'] }}" size="4" type="text"></td>
                                    <td class="product-quantity">
                                        <form enctype="multipart/form-data">
                                        <div class="product-signle-options product_15 clearfix">
                                            <div class="selector-wrapper size">
                                                <div class="quantity">
                                                    <input data-step="1" value="{{ $details['quantity'] }}" title="Qty" class="qty" size="4" type="text">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                    ...
                                    <td class="product-remove"><a class="remove" href="#" title="close"><img src="{{ asset('flower/img/icon-delete-cart.png')}}" alt="close"></a></td>
                                </tr>
