	...
	<div class="container">
			...
			<div class="row">
				<div class="slider-for">
					<div class="product-content">
						<div class="col-lg-5 col-md-6 col-sm-12 col-xs-12 img-content">
      							<img src="{{ asset('flower/img/340x420.png')}}" class="img-responsive" alt="img-holiwood">
      					</div>
      						<div class="col-lg-7 col-md-6 col-sm-12 col-xs-12 detail">
								...
								<div class="prince"><span>${{ $product['sell_price'] ?? 0 }}</span><s class="strike">${{ $product['off_price'] ?? 0 }}</s></div>
								<figure class="fi-option"><p class="option">Option</p></figure>
								<div class="size col-lg-4 col-md-6 col-sm-6 col-xs-12 hide">
									...
									<div class="Quality">
										...
										<div class="input-group input-number-group">
											<span class="text-qua">Quanty:</span>
											  ...
											  <span class="dola">$ </span><span class="total-prince">{{ $product['sell_price'] ?? 0 }}</span>
										</div>
										
									</div>
									<div class="add-cart">
										<a href=javascript:void(0) class="btn-add-cart add-to-cart-button" data-product-id="{{ $product->id }}">Add to cart</a>
										<a href="{{ url('product/'.$product->id) }}" class="list-icon icon-1"><i class="far fa-eye"></i></a>
				...
				<div class="slider-nav col-lg-5 col-md-6 col-sm-12 col-xs-12">
					<div><img src="{{ asset('flower/img/340x420.png')}}" class="img-responsive" alt="img-holiwood"></div>
					<div><img src="{{ asset('flower/img/340x420.png')}}" class="img-responsive" alt="img-holiwood"></div>
					<div><img src="{{ asset('flower/img/340x420.png')}}" class="img-responsive" alt="img-holiwood"></div>
					<div><img src="{{ asset('flower/img/340x420.png')}}" class="img-responsive" alt="img-holiwood"></div>
				</div>
	           ...
	           @foreach($related_products as $value)
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 product-category">
					<div class="product-image-category">
						<figure class="sale"><a href="#"><img src="{{ asset('flower/img/340x420.png')}}" class="img-responsive" alt="img-holiwood"></a></figure>
							<div class="product-icon-category">
								<a href="{{ url('product/'.$value->id) }}"><i class="far fa-eye"></i></a>
								<a href="#" class="add-to-cart-button" data-product-id="{{ $value->id }}" ><i class="fas fa-shopping-basket"></i></a>
					...
					<div class="product-title-category">
							...
							<div class="prince">${{ $value['sell_price'] ?? 0 }}<s class="strike">${{ $value['off_price'] ?? 0 }}</s></div>
					</div>
				</div>
				@endforeach
