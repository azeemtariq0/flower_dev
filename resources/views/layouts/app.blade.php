    ...
    <body>
        ...
        <!-- MIDDLE -->
            ...
            @if(Request::segment(3)!='')
                <a href="{{url('admin/').'/'.\Request::segment(2)}}" class="btn btn-default" style="float: right;"><i class="fa fa-undo"></i> Back</a>
                @endif

            </h1>
                <ol class="breadcrumb">
                    <li><a href="{{url('admin/').'/'.\Request::segment(2)}}">{{ucfirst(\Request::segment(1));}}</a></li>
                    @if(!empty($slug))
